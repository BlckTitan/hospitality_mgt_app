...
const DESCRIPTIONS: Record<GuidePage, string> = {
  ...
  maintenance:
    'Create a work order with +. Name a staff lead (and optional helpers) plus an optional vendor. Filter Unassigned, Mine, or Overdue. Preventive orders can also be created when an asset is due.',
  'maintenance-edit':
    'Start, complete, or cancel this order. Any assignee may start; only the lead or a supervisor can complete. Cancel requires notes. Completing preventive work updates the asset last and next maintenance dates.',
  inventory:
