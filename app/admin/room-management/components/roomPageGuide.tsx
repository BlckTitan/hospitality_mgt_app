...
const DESCRIPTIONS: Record<GuidePage, string> = {
  ...
  reservations:
    'Book a guest into a room for dates as pending or confirmed. Those stays block the nights. Use Confirm, Check in, Check out, or Cancel — do not pick status from a dropdown. Check-in occupies the room and can collect payment; check-out frees it, can collect the balance, and opens a checkout-clean. Guest count cannot exceed the room type’s max.',
  guests:
