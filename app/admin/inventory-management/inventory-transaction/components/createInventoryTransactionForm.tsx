...
export function FormComponent({ onSuccess, onClose, propertyId }: { onSuccess: () => void; onClose: () => void; propertyId: string }) {
  ...
  // For purchase transactions, quantity should be positive
  // For usage/waste, quantity should be positive (will be converted to negative)
  // For adjustment/transfer, quantity can be positive or negative
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="createInventoryTransactionForm">
