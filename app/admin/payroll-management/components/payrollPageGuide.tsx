...
const DESCRIPTIONS: Record<GuidePage, string> = {
  hub: 'Prepare, approve, and pay staff. Seed Payroll settings first, then approve Hours and Time off. Start payroll from a Pay cycle, Prepare pay, have another user Approve payroll, Download payment files, and Mark as paid.',
  ...
  hours: 'Record a day’s Hours with +, then Approve before they can be paid. A finalized bar shift creates a draft Hours row when the user is linked to staff — still approve it. After Prepare pay, included Hours are locked. Recalculate unlocks them only while the Payroll is Draft or Ready to review.',
