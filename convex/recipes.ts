...
export const getRecipe = query({
  ...
  handler: async (ctx, args) => {
    try {
      ...
      // Verify the recipe belongs to the property
      if (recipe.propertyId !== args.propertyId) {
        return { success: false, data: null, message: 'Unauthorized: Recipe does not belong to this property' };
      }
...
export const updateRecipe = mutation({
  ...
  handler: async (ctx, args) => {
    try {
      ...
      // Verify the recipe belongs to the property
      if (recipe.propertyId !== args.propertyId) {
        return { success: false, message: 'Unauthorized: Recipe does not belong to this property' };
      }
